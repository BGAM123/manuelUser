...
{
    #[Route('/{id}', name: 'app_asset_reevaluation_update', methods: ['PUT'])]
    #[OA\Put(
        path: '/asset-reevaluations/{id}',
        summary: 'Modifier une réévaluation de bien',
    ...
    #[OA\Response(
        response: 200,
        description: 'Réévaluation modifiée',
    ...
    public function __invoke(
        ...
        try {
            $reevaluation = $reevaluationService->update($reevaluation, $payload, $documents, $documentLabels, $currentUser);
    ...
    private function getPayload(Request $request): array
    {
        ...
        foreach (preg_split('/--' . preg_quote($boundary, '/') . '(?:--)?(?:\r\n|$)/', $content) ?: [] as $part) {
            ...
            // concerne uniquement les champs de la réévaluation.
