...
final class UpdateAssetReevaluationController extends AbstractController
{
    #[Route('/{id}/reevaluation', name: 'app_asset_update_reevaluation', methods: ['POST'])]
    #[OA\Post(
        path: '/assets/{id}/reevaluation',
        summary: 'Activer ou désactiver la réévaluation d\'un bien',
        description: "Permet d'activer ou de désactiver la réévaluation pour un bien spécifique.\n\n"
            . "**Statut actuel :** retourné dans la réponse.\n\n"
            . "**Exemple :** si `active` est true, la réévaluation est activée ; si false, elle est désactivée."
    )]
    #[OA\Parameter(
        name: 'id',
        in: 'path',
            ...
            schema: new OA\Schema(
                ...
                properties: [
                    new OA\Property(
                        ...
                        type: 'boolean',
                        example: true,
                        description: 'true pour activer la réévaluation, false pour la désactiver'
                    ),
                ]
            )
        )
    ...
    #[OA\Response(
        response: 200,
        description: 'Réévaluation mise à jour avec succès',
        content: new OA\JsonContent(
            example: [
                'success' => true,
                'status' => 200,
                'message' => 'Réévaluation mise à jour avec succès.',
                'data' => [
                    'id' => 1,
    ...
    public function __invoke(
        ...
        try {
            // Mettre à jour la réévaluation
            $asset = $assetManagementService->updateReevaluation($asset, $payload['active']);
        ...
        return $apiResponse->success(
            ...
            Response::HTTP_OK,
            'Réévaluation mise à jour avec succès.'
        );
    }
}