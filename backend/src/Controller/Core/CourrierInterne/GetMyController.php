...
class GetMyController extends AbstractController
{
    ...
    #[Route('/core/courrier-interne/my', name: 'app_core_courrier_interne_get_my', methods: ['GET'])]
    #[OA\Get(
        path: '/core/courrier-interne/my',
        summary: 'Lister les courriers internes crées par l\'utilisateur connecté',
        description: 'Retourne uniquement les courriers internes crées par l\'utilisateur connecté (rédacteur).',
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $this->actionLogger->logView(
            'CourrierInterne',
            null,
            'Consultation des courriers internes crées par l\'utilisateur connecté',
            [
