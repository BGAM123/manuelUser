...
class GetCollectionController extends AbstractController
{
    ...
    #[Route('/core/courrier-interne', name: 'app_core_courrier_interne_get_collection', methods: ['GET'])]
    #[OA\Get(
        path: '/core/courrier-interne',
        summary: 'Lister les courriers internes créés par l\'utilisateur connecté',
        description: '
## Description
Retourne la liste des courriers internes créés par l\'utilisateur connecté (rédacteur).

Chaque courrier interne inclut :
- Les courriers associés (via transmissions)
...
## Filtres disponibles
Mêmes paramètres de filtre que l\'API des réponses.',
        ...
        responses: [
            new OA\Response(
                response: 200, 
                description: '**Succès** - Liste des courriers internes de l\'utilisateur connecté',
    ...
    public function list(Request $request): Response
    {
        ...
        $formatReponse = function($r) {
            ...
            return [
                ...
                'commentaireInterne' => $r->getCommentaireInterne(),
                ...
                'updatedAt' => $r->getUpdatedAt()?->format('Y-m-d'),
            ];
        };
