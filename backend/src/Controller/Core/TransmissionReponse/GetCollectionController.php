...
class GetCollectionController extends AbstractController
{
    ...
    #[Route('/core/transmission-reponse', name: 'app_core_transmission_reponse_get_collection', methods: ['GET'])]
    #[OA\Get(
        path: '/core/transmission-reponse',
        summary: 'Lister les transmissions reponse du service connecte avec filtres et pagination',
        description: 'Retourne la liste des transmissions reponse recues par le service de l\'utilisateur connecte.',
    ...
    public function list(Request $request): Response
    {
        ...
        if ($requiresPostFiltering) {
            ...
            $allServiceResponses = array_values(array_filter($allServiceResponses, function ($response) use ($typeCourrierFilter, $linkedServiceDestinataireFilter, $linkedStatutFilterNormalized, $searchFilterNormalized, $courrierInterneByIdForSearch, $currentUser) {
                ...
                if ($searchFilterNormalized !== null) {
                    ...
                    ] = $this->computeTransmissionPermissions($response, $currentUser);
        ...
        $currentUserForTransmit = $currentUser;
        $formatReponse = function($r) use ($currentUserForTransmit, $courrierInterneNumerosById) {
            $piecesJointes = $this->pieceJointeRepository->findBy([
                'idParent' => $r->getId(),
                'typeParent' => 'TransmissionReponse',
                'isDelete' => false
            ...
            [
                ...
                $latestUserTransmissionId,
                $latestUserTransmissionCanModify
            ] = $this->computeTransmissionPermissions($r, $currentUserForTransmit);
        ...
        $this->actionLogger->logView(
            'TransmissionReponse',
            null,
            'Consultation de la liste des transmissions reponse (service connecte)',
            [
