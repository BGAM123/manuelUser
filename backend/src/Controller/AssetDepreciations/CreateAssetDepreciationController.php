...
final class CreateAssetDepreciationController extends AbstractController
{
    #[Route('', name: 'app_asset_depreciation_create', methods: ['POST'])]
    #[OA\Post(
        path: '/asset-depreciations',
        summary: 'Créer une dépréciation de bien',
    ...
    #[OA\Response(
        response: 201,
        description: 'Dépréciation créée',
        content: new OA\JsonContent(
            example: [
                'success' => true,
                'status' => 201,
                'message' => 'Dépréciation créée avec succès.',
                'data' => [
                    'id' => 3,
    ...
    public function __invoke(
        ...
        try {
            $depreciation = $depreciationService->create($payload, $documents, $documentLabels, $currentUser);
        ...
        return $apiResponse->success(
            ...
            'Dépréciation créée avec succès.'
        );
    }
}
