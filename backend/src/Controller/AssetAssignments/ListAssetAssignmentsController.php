...
use App\Service\AssetAssignmentListResponseBuilder;
...
final class ListAssetAssignmentsController extends AbstractController
{
    #[Route('', name: 'app_asset_assignment_list', methods: ['GET'], priority: 10)]
    #[OA\Get(
        path: '/asset-assignments',
        summary: 'Lister les affectations de biens',
        description: 'Liste paginée des affectations avec la même structure que le listing des biens. Chaque item contient l\'ID de l\'affectation (assignmentId) au début, suivi des informations du bien, et des champs spécifiques à l\'affectation (dateDebut, dateFin, typeAffectation, commentaire, detenteur, isAcknowledged, isCurrentUserDetenteur).'
    )]
    ...
    #[OA\Parameter(name: 'search', in: 'query', schema: new OA\Schema(type: 'string'), description: 'Recherche sur nom, référence, numéro de série du bien')]
    ...
    #[OA\Response(
        ...
        content: new OA\JsonContent(
            example: [
                'success' => true,
                'status' => 200,
                'message' => 'Affectations retournées avec succès.',
                'data' => [
    ...
    public function __invoke(
        ...
        AssetAssignmentListResponseBuilder $responseBuilder,
        ...
        return $apiResponse->success([
            'meta' => $meta,
            'data' => $data,
        ], Response::HTTP_OK, 'Affectations retournées avec succès.');
    }
}
