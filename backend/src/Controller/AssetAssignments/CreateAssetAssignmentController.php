...
final class CreateAssetAssignmentController extends AbstractController
{
    #[Route('', name: 'app_asset_assignment_create', methods: ['POST'])]
    #[OA\Post(
        path: '/asset-assignments',
        summary: 'Créer une affectation de bien',
    ...
    public function __invoke(
        ...
        try {
            $assignment = $assignmentService->create($payload, $documents, $documentLabels, $user);
