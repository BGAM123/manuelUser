 ...
 */
final class Version20260829124111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventory_campaign ADD CONSTRAINT FK_AB5FA84CED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE inventory_campaign ADD CONSTRAINT FK_AB5FA84C12469DE2 FOREIGN KEY (category_id) REFERENCES category (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE inventory_campaign ADD CONSTRAINT FK_AB5FA84CB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE inventory_campaign ADD CONSTRAINT FK_AB5FA84C896DBBDE FOREIGN KEY (updated_by_id) REFERENCES user (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE inventory_campaign_item ADD CONSTRAINT FK_7DF1DD08F639F774 FOREIGN KEY (campaign_id) REFERENCES inventory_campaign (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE inventory_campaign_item ADD CONSTRAINT FK_7DF1DD085DA1941 FOREIGN KEY (asset_id) REFERENCES asset (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE inventory_campaign_item ADD CONSTRAINT FK_7DF1DD08A5CB0CEF FOREIGN KEY (verifie_par_id) REFERENCES user (id) ON DELETE SET NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inventory_campaign DROP FOREIGN KEY FK_AB5FA84CED5CA9E6');
        $this->addSql('ALTER TABLE inventory_campaign DROP FOREIGN KEY FK_AB5FA84C12469DE2');
        $this->addSql('ALTER TABLE inventory_campaign DROP FOREIGN KEY FK_AB5FA84CB03A8386');
        $this->addSql('ALTER TABLE inventory_campaign DROP FOREIGN KEY FK_AB5FA84C896DBBDE');
        $this->addSql('ALTER TABLE inventory_campaign_item DROP FOREIGN KEY FK_7DF1DD08F639F774');
        $this->addSql('ALTER TABLE inventory_campaign_item DROP FOREIGN KEY FK_7DF1DD085DA1941');
        $this->addSql('ALTER TABLE inventory_campaign_item DROP FOREIGN KEY FK_7DF1DD08A5CB0CEF');
